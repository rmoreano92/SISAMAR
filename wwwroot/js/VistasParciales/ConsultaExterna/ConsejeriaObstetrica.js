let ConsejeriaObstetrica = {
    ...
    async CargarFormData(formData) {
        ...
        formData.append("NroCPN", $("#txtNroCPN").val());

        //formData.append("BeneficioLactanciaMaterna", $("#chkBeneficioLactanciaMaterna").val());
        //formData.append("LactanciaMaternaLibreDemanda", $("#chkLactanciaMaternaLibreDemanda").val());
        //formData.append("ContactoPielPiel", $("#chkContactoPielPiel").val());
        //formData.append("AlojamientoConjunto", $("#chkAlojamientoConjunto").val());
        //formData.append("ExtraccionConservacionLecheMaterna", $("#chkExtraccionConservacionLecheMaterna").val());
        //formData.append("TecnicasAmamantamiento", $("#chkTecnicasAmamantamiento").val());
        //formData.append("SucedaneosBiberonesTetinas", $("#chkSucedaneosBiberonesTetinas").val());
        //formData.append("CorteOportunoCordonUmbilical", $("#chkCorteOportunoCordonUmbilical").val());
        //formData.append("LactanciaMaternaPrimeraHora", $("#chkLactanciaMaternaPrimeraHora").val());
        //formData.append("DonacionLecheMaterna", $("#chkDonacionLecheMaterna").val());

        formData.append("BeneficioLactanciaMaterna", $("#chkBeneficioLactanciaMaterna").prop("checked") ? 1 : 0);
        formData.append("LactanciaMaternaLibreDemanda", $("#chkLactanciaMaternaLibreDemanda").prop("checked") ? 1 : 0);
        formData.append("ContactoPielPiel", $("#chkContactoPielPiel").prop("checked") ? 1 : 0);
        formData.append("AlojamientoConjunto", $("#chkAlojamientoConjunto").prop("checked") ? 1 : 0);
        formData.append("ExtraccionConservacionLecheMaterna", $("#chkExtraccionConservacionLecheMaterna").prop("checked") ? 1 : 0);
        formData.append("TecnicasAmamantamiento", $("#chkTecnicasAmamantamiento").prop("checked") ? 1 : 0);
        formData.append("SucedaneosBiberonesTetinas", $("#chkSucedaneosBiberonesTetinas").prop("checked") ? 1 : 0);
        formData.append("CorteOportunoCordonUmbilical", $("#chkCorteOportunoCordonUmbilical").prop("checked") ? 1 : 0);
        formData.append("LactanciaMaternaPrimeraHora", $("#chkLactanciaMaternaPrimeraHora").prop("checked") ? 1 : 0);
        formData.append("DonacionLecheMaterna", $("#chkDonacionLecheMaterna").prop("checked") ? 1 : 0);
        ...
        formData.append("esConsejeria", 1);
    ...
    async Iniciar() {
        ConsejeriaObstetrica.CargaInicial();
        ConsejeriaObstetrica.Eventos();

        ConsejeriaObstetrica.InitDatablesDiagnosticosUltimoControlCita()
        ConsejeriaObstetrica.InitDatablesTiposConsejeria()

        await ConsejeriaObstetrica.TiposClasificacionPaciente();
        await ConsejeriaObstetrica.ListarCptConsejeriaObstetrica();
