let EcografiaUtero = {
    ...
    ListaEcoUteroGravido: async function (IdMovimiento, IdProducto, Numero) {
        ...
        let response = await HttpClient.Post(`/ImagenesResultados/ListaEcoUteroGravido`, formData)
    ...
    CargarDatos: async function () {
        ...
        let res = await EcografiaUtero.ListaEcoUteroGravido(Imagenologia.idMovimiento, Imagenologia.idProducto, 1)

        if (res) {
            EcografiaUtero.CargarResultadoEcoVaginalBasica(res)
        }

        res = await EcografiaUtero.ListaEcoUteroGravido(Imagenologia.idMovimiento, Imagenologia.idProducto, 2)

        if (res) {
            EcografiaUtero.CargarResultadoEcoVaginalBasica(res)
        }

        res = await EcografiaUtero.ListaEcoUteroGravido(Imagenologia.idMovimiento, Imagenologia.idProducto, 3)
    ...
    CargarResultadoEcoVaginalBasica: function (data) {
        ...
        if (data.numeroFeto == 1) {
            ...
            $('#cboSexoFeto1').val(data.idtipoSexoEco);
            ...
            $('#cboMorfFetalFeto1').val(data.morfFetal);
            ...
            $('#cboSexoFeto2').val(data.idtipoSexoEco);
            ...
            $('#cboMorfFetalFeto2').val(data.morfFetal);
            ...
            $('#cboSexoFeto3').val(data.idtipoSexoEco);
            ...
            $('#cboMorfFetalFeto3').val(data.morfFetal);
    ...
    async GuardarResultado() {
        ...
        if ($('input[name="rdbFeto"]:checked').val() >= 1) {
            ...
            formData.append('MorfFetal', $('#cboMorfFetalFeto1').val());
            ...
            response = await HttpClient.Post(`/ImagenesResultados/InsertaEcoUteroGravido`, formData)
        }
        ...
        if ($('input[name="rdbFeto"]:checked').val() >= 2) {
            ...
            formData.append('MorfFetal', $('#cboMorfFetalFeto2').val());
            formData.append('IdExamen', Imagenologia.idProducto);
            formData.append('IdOrden', Imagenologia.idOrden);
            formData.append('IdMedico', $('#cboRealizaPrueba').val());
            formData.append('IdMovimiento', Imagenologia.idMovimiento);
        ...
        if ($('input[name="rdbFeto"]:checked').val() >= 3) {
            ...
            formData.append('MorfFetal', $('#cboMorfFetalFeto3').val());
            formData.append('IdExamen', Imagenologia.idProducto);
            formData.append('IdOrden', Imagenologia.idOrden);
            formData.append('IdMedico', $('#cboRealizaPrueba').val());
            formData.append('IdMovimiento', Imagenologia.idMovimiento);
    ...
    Init: async function () {
        ...
        await EcografiaUtero.Plugins()

        await EcografiaUtero.Events()

        await EcografiaUtero.TiposSexoSeleccionarTodosEcografias();
        await EcografiaUtero.ListaComboMorfFetal(40);
        await EcografiaUtero.ListaComboDetalle(41);
        await EcografiaUtero.ListaComboLiquido(42);
        await EcografiaUtero.ListaComboPresentacion(36);
        await EcografiaUtero.ListaComboPlacenta(37);
        await EcografiaUtero.ListaComboGrado(38);
        await EcografiaUtero.ListaComboCordon(39);
    }
}