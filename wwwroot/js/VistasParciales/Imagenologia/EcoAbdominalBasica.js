var EcoAbdominalBasica = {

    async Iniciar() {
        EcoAbdominalBasica.Plugins();
        EcoAbdominalBasica.Eventos();
        await EcoAbdominalBasica.CargarCombos();
    ...
    Eventos() {
        ...
        $("#txtFechaFUR").on('change', async function () {
            ...
            await EcoAbdominalBasica.CalcularEdadGestacional(valor);
        });
    ...
    async SeleccionarResultadoEcografia(idOrden, idMovimiento, idProducto) {
        ...
        try {
            ...
            datos = await
                $.ajax({
                    method: "POST",
                    url: "/ImagenologiaEcografias/SeleccionarEcoAbdominalBasica?area=Imagenologia",
    ...
    DevolverDetalleResultado() {
        ...
        for (let i = 1; i <= fetos; i++) {
            objRes = {
                ...
                Fecha: null,                
                Fc: $('#txtFcfFeto' + i).val(),
                CervixUterino: $('#txtCervixFeto' + i).val(),                
                FUR: $('#txtFechaFUR').val(),
                FPP: $('#txtFechaFPP').val(),
                Usuario: null,
                UsuarioUpdate: null,
    ...
    async GuardarResultado() {
        ...
        try {
            ...
            datos = await
                $.ajax({
                    method: "POST",
                    url: "/ImagenologiaEcografias/GuardarEcoAbdominalBasica?area=Imagenologia",
                    //contentType: "application/json; charset=utf-8",
                    data: midata,
                    dataType: "json",
                    cache: false,
