        ...
        switch (idCatalogo) {
            case 21:
                ...
                dataRx.each(function (value, index) {
                    ...
                    html += '{"idItem":"' + dataRx[index]["idItem"] + '","cantidadPedida":"' + $(txtCant).val() + '","precio":"' + dataRx[index]["precio"] + '","total":"' + dataRx[index]["total"] + '"},';       //KHOYOSI
            ...
            case 23:
                ...
                dataEcoObs.each(function (value, index) {
                    ...
                    html += '{"idItem":"' + dataEcoObs[index]["idItem"] + '","cantidadPedida":"' + $(txtCant).val() + '","precio":"' + dataEcoObs[index]["precio"] + '","total":"' + dataEcoObs[index]["total"] + '"},';       //KHOYOSI
                    //console.log(data[index]["idItem"] + '- ' + index);
                });
                break;
            ...
            case 24:
                ...
                dataEcoObsProc.each(function (value, index) {
                    ...
                    //html += '{"idItem":"' + dataEcoObs[index]["idItem"] + '","cantidadPedida":"' + dataEcoObs[index]["cantidadPedida"] + '","precio":"' + dataEcoObs[index]["precio"] + '","total":"' + dataEcoObs[index]["total"] + '"},';       //KHOYOSI(COMENTADO)
                    html += '{"idItem":"' + dataEcoObsProc[index]["idItem"] + '","cantidadPedida":"' + $(txtCant).val() + '","precio":"' + dataEcoObsProc[index]["precio"] + '","total":"' + dataEcoObsProc[index]["total"] + '"},';       //KHOYOSI
                    //console.log(data[index]["idItem"] + '- ' + index);
                });
                break;
            ...
            case 20:
                ...
                dataEcoGeneral.each(function (value, index) {
                    ...
                    html += '{"idItem":"' + dataEcoGeneral[index]["idItem"] + '","cantidadPedida":"' + $(txtCant).val() + '","precio":"' + dataEcoGeneral[index]["precio"] + '","total":"' + dataEcoGeneral[index]["total"] + '"},';       //KHOYOSI
                    //console.log(data[index]["idItem"] + '- ' + index);
                });
                break;
            ...
            case 3:
                ...
                dataanatPatologica.each(function (value, index) {
                    ...
                    html += '{"idItem":"' + dataanatPatologica[index]["idItem"] + '","cantidadPedida":"' + $(txtCant).val() + '","precio":"' + dataanatPatologica[index]["precio"] + '","total":"' + dataanatPatologica[index]["total"] + '"},';       //KHOYOSI
                    //console.log(data[index]["idItem"] + '- ' + index);
                });
                break;
            ...
            case 2:
                ...
                dataPatoClinica.each(function (value, index) {
                    ...
                    html += '{"idItem":"' + dataPatoClinica[index]["idItem"] + '","cantidadPedida":"' + $(txtCant).val() + '","precio":"' + dataPatoClinica[index]["precio"] + '","total":"' + dataPatoClinica[index]["total"] + '"},';       //KHOYOSI
                    //console.log(data[index]["idItem"] + '- ' + index);
                });
                break;
            ...
            case 11:
                ...
                databancoSangre.each(function (value, index) {
                    ...
                    html += '{"idItem":"' + databancoSangre[index]["idItem"] + '","cantidadPedida":"' + $(txtCant).val() + '","precio":"' + databancoSangre[index]["precio"] + '","total":"' + databancoSangre[index]["total"] + '"},';       //KHOYOSI
                    //console.log(data[index]["idItem"] + '- ' + index);
                });
                break
            ...
            case 5:
                ...
                databafarmacia.each(function (value, index) {
                    ...
                    html += '{"idItem":"' + databafarmacia[index]["idItem"] + '","cantidadPedida":"' + $(txtCant).val() + '","precio":"' + databafarmacia[index]["precio"] + '","total":"' + databafarmacia[index]["total"] + '","idDosisRecetada":"' + databafarmacia[index]["idDosisRecetada"] + '","idViaAdministracion":"' + databafarmacia[index]["idViaAdministracion"] + '","observaciones":"' + $(txtFrec).val() + '"},';       //KHOYOSI
                });
                break;
        }
        html += ']';
            ...
            success: function (datos) {
                ...
                if (datos.table.length > 0) {//rx
                    ...
                    $(datos.table).each(function (i, obj) {
                        ...
                        if (obj.idPuntoCarga == 24) {//eco obs proce
                            $('#lblEcoObsProc').html("Receta Nro.: " + obj.idReceta);
                            $('#hdIdRecetaEcoObsProc').val(obj.idReceta);
                            Ordenes.listaRecetasByIdRecetaByPuntoCarga(obj.idReceta, 24)
                            if (obj.idEstado === 1) {
