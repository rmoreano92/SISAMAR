...
var ConsumoServicio = {
    ...
    ListaCptByPuntoCargaByFuente(idPuntoCarga, idTipoFinanciamiento) {
        ...
        $.ajax({
            ...
            success: function (datos) {
                ...
                $(datos.table).each(function (i, obj) {
                    $('#cboProductoServicio').append('<option  value="' + obj.idProducto + '">' + obj.nombre + '</option>');
                });
    ...
    eventos() {
        ...
        $('#btnAgregarPS').on('click', function () {
        ...
        $("#modalConsumoServicio").on('hidden.bs.modal', function () {
            ...
            ConsumoServicio.BuscaAtencionesCptCEparaFormatoHIS(ConsumoServicio.idCuentaAtencion)
        });
        ...
        $('#btnEliminarCSAtencion').on('click', function () {
            ...
            if (ConsumoServicio.idEstadoAtencion == 2) {
        ...
        $('#btnActualizaCSAtencion').on('click', function () {
            var objrow = oTable_consumoServAtencion.api(true).row('.selected').data();
        ...
        $('#btnAgregarCSAtencion').on('click', function () {
            ...
            ConsumoServicio.limpiar();
            //var objrow = oTable_consumoServAtencion.api(true).row('.selected').data();
            $("#txtNroCuentaRegistro").val(ConsumoServicio.idCuentaAtencion);
            ConsumoServicio.listaPorCuenta(ConsumoServicio.idCuentaAtencion, 1); // bloquear aqui
            $('#modalConsumoServicio').modal('show');
        });
