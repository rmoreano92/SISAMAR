let TamizajeNeonatal = {
    ...
    AtencionesSeleccionarPacExtPorCuentaHistoriaApellidosServSEGUROSTamizaje: function (NroCuenta, HistoriaClinica, ApellidoPaterno, ApellidoMaterno, fechaIngreso) {
        let formData = new FormData();
        ...
        return HttpClient.Post('/Atencion/AtencionesSeleccionarPacExtPorCuentaHistoriaApellidosServSEGUROSTamizaje', formData)
            .then(res => {
    ...
    ValidarPacienteSis: async (objRowSis, idPaciente) => {

        let pacientes = null
        let paciente = null


        paciente = await TamizajeNeonatal.PacientesSeleccionarPorId(idPaciente)
        ...
        $(`#cboTipoDocMadre`).val(paciente.madreTipoDocumento)
    ...
    ValidarPacienteCrearHistoria: async (objRowSis) => {
        ...
        TamizajeNeonatal.IdTipoDocumento = (objRowSis[12] == '2' ? '1' : '7')
        TamizajeNeonatal.NroDocumento = objRowSis[13]

        $('#cboTipoDocPaciente').val(TamizajeNeonatal.IdTipoDocumento)
        $('#txtNroDocumentoPaciente').val(TamizajeNeonatal.NroDocumento)
                ...
                .then(async (res) => {
                    if (res) {
                        ...
                        let idPaciente = await TamizajeNeonatal.CrearModificarHistoria(
                            ...
                            FechaNacimiento = objRowSis[4], NroDocumento = $('#txtNroDocumentoPaciente').val(), IdTipoSexo = (objRowSis[9] == '1' ? 1 : 2), IdDocIdentidad = $('#cboTipoDocPaciente').val(), NroHistoriaClinica = TamizajeNeonatal.NroHistoria,
                            IdTipoNumeracion = 1, madreDocumento = $('#txtDocumentoMadre').val(), madreTipoDocumento = $('#cboTipoDocMadre').val()
                        )
                        ...
                        if (!isEmpty(idPaciente)) {
                            ...
                            alerta(4, 'Problemas al crear la historia')
                            return null
                        }
                        ...
                        await TamizajeNeonatal.ValidarPacienteSis(objRowSis, idPaciente)
        ...
        $('#txtTipoCabecera').val(objRowSis[12])
        $('#txtNroAfiliacionCabecera').val(objRowSis[13])
        await TamizajeNeonatal.ValidarPacienteSis(objRowSis, pacientes[0].idPaciente)
    },

    ValidarPacienteSisV2: async (datosAfiliacion, idPaciente) => {
        ...
        //$('#txtApellidoPaterno').val(datosAfiliacion.apePaterno)
        //$('#txtApellidoMaterno').val(datosAfiliacion.apeMaterno)
        //$('#txtPrimerNombre').val(datosAfiliacion.nombres.split(' ')[0])
        //$('#txtSegundoNombre').val(datosAfiliacion.nombres.split(' ')[1])
        ...
        //$('#cboTipoSexo').val(datosAfiliacion.genero == 0 ? 2 : 1)
        //$('#txtDisaCabecera').val(datosAfiliacion.disa)
        //$('#txtTipoCabecera').val(datosAfiliacion.tipoFormato)
        //$('#txtNroAfiliacionCabecera').val(datosAfiliacion.nroContrato)
        //$('#txtEdadAtencion').val(edad)
        //$('#cboTipoEdadAtencion').val(tipoEdad)
    ...
    //ValidarPacienteCrearHistoriaV2: async (datosAfiliacion) => {
    //    let paciente = null
    //    let pacientes = null
    ...
    //    pacientes = await TamizajeNeonatal.PacientesFiltrarTodosSoloHistorias(
    //        nroHistoriaClinica = '', apellidoPaterno = '', apellidoMaterno = '', primerNombre = '', segundoNombre = '', idDocIdentidad = 7, nroDocumento = datosAfiliacion.nroContrato
    //    )


    //    TamizajeNeonatal.NroDocumento = datosAfiliacion.nroContrato
    //    TamizajeNeonatal.IdTipoDocumento = 7
    ...
    //                    let idSiaSis = await TamizajeNeonatal.SisFiliacionesAgregar(
    //                        idSiasis = datosAfiliacion.idNumReg, Codigo = datosAfiliacion.tabla, AfiliacionDisa = datosAfiliacion.disa, AfiliacionTipoFormato = datosAfiliacion.tipoFormato,
    //                        AfiliacionNroFormato = datosAfiliacion.nroContrato, AfiliacionNroIntegrante = datosAfiliacion.correlativo, DocumentoTipo = datosAfiliacion.tipoDocumento,
    //                        CodigoEstablAdscripcion = datosAfiliacion.eess, AfiliacionFecha = datosAfiliacion.fecAfiliacion, Paterno = datosAfiliacion.apePaterno, Materno = datosAfiliacion.apeMaterno,
    //                        Pnombre = datosAfiliacion.nombres.split(' ')[0], Onombres = datosAfiliacion.nombres.split(' ')[1], Genero = datosAfiliacion.genero,
    //                        Fnacimiento = datosAfiliacion.fecNacimiento.substr(6, 2) + '/' + datosAfiliacion.fecNacimiento.substr(4, 2) + '/' + datosAfiliacion.fecNacimiento.substr(0, 4),
    //                        IdDistritoDomicilio = datosAfiliacion.eessUbigeo, Estado = 0, Fbaja = '', DocumentoNumero = datosAfiliacion.nroDocumento, MotivoBaja = '', FbajaOK = ''
    //                    )

    //                    let idPaciente = await TamizajeNeonatal.CrearModificarHistoria(
    //                        IdPaciente = TamizajeNeonatal.IdPaciente, ApellidoPaterno = datosAfiliacion.apePaterno, ApellidoMaterno = datosAfiliacion.apeMaterno, PrimerNombre = datosAfiliacion.nombres.split(' ')[0],
    //                        SegundoNombre = datosAfiliacion.nombres.split(' ')[1], TercerNombre = '',
    //                        FechaNacimiento = datosAfiliacion.fecNacimiento.substr(6, 2) + '/' + datosAfiliacion.fecNacimiento.substr(4, 2) + '/' + datosAfiliacion.fecNacimiento.substr(0, 4),
    //                        NroDocumento = datosAfiliacion.nroContrato,
    //                        IdTipoSexo = (datosAfiliacion.genero == 0 ? 2 : 1), IdDocIdentidad = 7, NroHistoriaClinica = TamizajeNeonatal.NroHistoria,
    //                        IdTipoNumeracion = 1, madreDocumento = $('#txtDocumentoMadre').val(), madreTipoDocumento = $('#cboTipoDocMadre').val()
    //                    )
    ...
    //                    await TamizajeNeonatal.ValidarPacienteSisV2(datosAfiliacion, idPaciente)
    ...
    //    //$('#txtTipoCabecera').val(objRowSis[12])
    //    //$('#txtNroAfiliacionCabecera').val(objRowSis[13])
    //    await TamizajeNeonatal.ValidarPacienteSisV2(datosAfiliacion, pacientes[0].idPaciente)
    //},
    ...
    RegistrarAtencionTamizajeNeonatal: async () => {
        Cargando(1)
        ...
        let idPaciente = await TamizajeNeonatal.CrearModificarHistoria(
            ...
            SegundoNombre = $('#txtSegundoNombre').val(), TercerNombre = '', FechaNacimiento = $('#txtFechaNacimiento').val(), NroDocumento = $('#txtNroDocumentoPaciente').val(), IdTipoSexo = $('#cboTipoSexo').val(),
            IdDocIdentidad = $('#cboTipoDocPaciente').val(), NroHistoriaClinica = TamizajeNeonatal.NroHistoria, IdTipoNumeracion = 1, madreDocumento = $('#txtDocumentoMadre').val(), madreTipoDocumento = $('#cboTipoDocMadre').val()
        )
        ...
        if ($('#cboProductoPlan').val() == 2) {
            ...
            const Refere = await TamizajeNeonatal.GuardarConRef(FactCuentaAtencion, TamizajeNeonatal.IdContraReferencia)
        }
    ...
    ListarAtenciones: async function () {
        ...
        let atenciones = await TamizajeNeonatal.AtencionesSeleccionarPacExtPorCuentaHistoriaApellidosServSEGUROSTamizaje($('#txtNroCuentaBusqueda').val(), $('#txtNroHistoriaBusqueda').val(), $('#txtNroApellidoPaternoBusqueda').val(), $('#txtNroApellidoMaternoBusqueda').val(), $('#txtFechaAtencion').val())
    ...
    GuardarConRef(FactCuentaAtencion, IdContraReferencia) {
        var formData = new FormData();
        formData.append('NroHojaContraReferencia', $('#txtNroReferenciaDestino').val());
        //formData.append('IdCuentaAtencion', objrow.idCuentaAtencion);
        formData.append('IdContraReferencia', IdContraReferencia);
        formData.append('IdCuentaAtencion', FactCuentaAtencion);
        formData.append('IpressOrigen', '06208');
        formData.append('IpressDestino', $('#txtIdReferenciaCita').val());
        formData.append('ServicioOrigen', '');
        formData.append('ServicioDestino', '');
        formData.append('Especialidad', '');
        formData.append('DxOrigen', 'Dx 1 = Z138 - Examen de pesquisa especial para otras enfermedades y trastornos especificados   (P  =  Presuntivo)');
        formData.append('DxIngreso', 'Dx 1 = Z138 - Examen de pesquisa especial para otras enfermedades y trastornos especificados   (P  =  Presuntivo)');
        formData.append('DxEgreso', 'Dx 1 = Z138 - Examen de pesquisa especial para otras enfermedades y trastornos especificados   (P  =  Presuntivo)');
        formData.append('Tratamiento', '');
        formData.append('Recomendaciones', '');
        formData.append('Calificacion', '');
        formData.append('CondicionUsuario', '');
        formData.append('DescOrigen', '');
        formData.append('DescServicioOrigen', '');
        formData.append('DescDestino', '');
        formData.append('DescServicioDestino', '');
        //formData.append('DxEgreso', '');
        formData.append('DescEspecialidad', '');

        formData.append('IdResponsable', '');
        formData.append('IdResponsableEESS', '');
                ...
                if (datos.session) {
                    if (datos.respuesta.table.length > 0) {
                        ...
                        if (respuesta.mensaje == "Exito") {
                            alerta(1, 'La Contrareferencia se creo correctamente.');
                        }
    ...
    Events: () => {
        ...
        $('#btnModificarAtenciones').on('click', async function () {
            ...
            TamizajeNeonatal.IdContraReferencia = atencion.idContraReferencia
            ...
            $('#cboTipoDocMadre').val(atencion.madreTipoDocumento)
            ...
            $('#cboMedicoResponsable').val(atencion.idMedicoIngreso)
            ...
            TamizajeNeonatal.IdMedico = atencion.idMedicoIngreso
            ...
            TamizajeNeonatal.IdTipoDocumento = atencion.idDocIdentidad
            TamizajeNeonatal.NroDocumento = atencion.nroDocumento
        ...
        $('#btnBuscarPacientes').on('click', async function () {
            ...
            //    await TamizajeNeonatal.ValidarPacienteCrearHistoriaV2(datosAfiliacion)
            ...
            //        pacientes = await TamizajeNeonatal.ListarAfiliadosSis(250, 2, $('#txtDniBusquedaPaciente').val(), $('#cboTipoAfiliacion').val())
            //    } else {
        ...
        $('#btnGuardar').on('click', async function () {
            ...
            if ($('#txtNroHistoria').val() == '') {
                alerta(2, 'Debe ingresar un paciente para continuar con el registro')
                return false
            }
            ...
            //    return false
            //}
            if ($('#cboTipoDocMadre').val() == 0) {
                alerta(2, 'Ingresa el Tipo de Documento de la Madre')
                $('#cboTipoDocMadre').focus()
                return false
            }
            ...
            if (!isEmpty(atencionesByIdPaciente)) {
                if (atencionesByIdPaciente.data.table.length > 0 && TamizajeNeonatal.accion == 1) {
                    swal({
                        ...
                        .then(async (res) => {
                            if (res) {
                                TamizajeNeonatal.RegistrarAtencionTamizajeNeonatal()
                            }
                        })
                } else {
                    TamizajeNeonatal.RegistrarAtencionTamizajeNeonatal()
        ...
        $('#cboTipoAfiliacion').on('change', () => {
            if ($('#cboTipoAfiliacion').val() == 8) {
                $('#txtDisa').val('250')
                $('#txtTipo').val('E')
            } else if ($('#cboTipoAfiliacion').val() == 7) {
                $('#txtDisa').val('250')
                $('#txtTipo').val('2')
            } else {
                $('#txtDisa').val('')
