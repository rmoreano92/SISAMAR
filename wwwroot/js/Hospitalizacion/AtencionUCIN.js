var AtencionUCIN = {
    async Iniciar() {
        await AtencionUCIN.Plugins();
        AtencionUCIN.InitDatablesAtencionesUCI();
        AtencionUCIN.Eventos();
    ...
    Eventos() {
        ...
        $('#btnModificarAtencion').on('click', async function () {
            ...
            //if (AtencionUCIN.VaidarEstadoAtencion()) {
            //    MostrarAreaRegistro();
            //} 
            MostrarAreaRegistro();
