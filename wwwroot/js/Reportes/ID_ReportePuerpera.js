...
var ID_ReportePuerpera = {
    ...
    GenerarReporte() {
        ...
        var url = "/Reportes/rptProduccionEstadisticaObstetras2?area=Reportes&FechaInicio=" + FechaInicio + "&FechaFin=" + FechaFin + "&TipoServicio=" + TipoServicio;
...
$(document).ready(function () {
    ID_ReportePuerpera.inicializarComponentes();
});
