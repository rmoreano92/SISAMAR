...
var ID_ParteDiarioCitas = {
    ...
    inicializarComponentes() {
        ...
        $("#cboEspecialidad").on('change', function () {
            //ID_ParteDiarioCitas.cargarComboEspecialidades();
            ID_ParteDiarioCitas.cargarComboServicios();
        });
    ...
    listarCombos() {
        ...
        $.ajax({
            async: false,
            cache: false,
            url: "/Reportes/ListarMedicos?area=ConsultaExterna",
            datatype: "json",
            type: "get",
            success: function (datos) {
                ...
                $('#cboMedico').empty();
                $(datos.table).each(function (i, obj) {
                    $('#cboMedico').append('<option  value="' + obj.idMedico + '">' + obj.medico + '</option>');
                });
                $('.chzn-select').chosen().trigger("chosen:updated");
            },
            error: function (msg) {
    ...
    GenerarReporte() {
        ...
        var url = "/Reportes/ParteDiarioCitas?area=Reportes&idTipoServicio=" + idTipoServicio
            + "&idDepartamento=" + idDepartamento + "&idEspecialidad=" + idEspecialidad
            + "&idServicio=" + idServicio + "&idDestino=" + idDestino + "&idMedico=" + idMedico + "&FechaInicio=" + FechaIni+"&FechaFin=" + FechaFin;
    ...
    GenerarReporteResumido() {
        ...
        var url = "/Reportes/ParteDiarioCitasResumido?area=Reportes&idTipoServicio=" + idTipoServicio
            + "&idDepartamento=" + idDepartamento + "&idEspecialidad=" + idEspecialidad
            + "&idServicio=" + idServicio + "&idDestino=" + idDestino + "&idMedico=" + idMedico + "&FechaInicio=" + FechaIni + "&FechaFin=" + FechaFin;
        window.location.href = url;
    },
...
$(document).ready(function () {
    ID_ParteDiarioCitas.inicializarComponentes();
    ID_ParteDiarioCitas.listarCombos();
    ID_ParteDiarioCitas.cargarComboServicios();
    ID_ParteDiarioCitas.cargarComboEspecialidades();
