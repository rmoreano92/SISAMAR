var FechaDia;
var ID_PacienteCronico = {


    inicializarComponentes() {
        $("#cboDepartamento").on('change', function () {
            ID_PacienteCronico.cargarComboEspecialidades();
        });
        $("#cboEspecialidad").on('change', function () {
            //ID_PacienteCronico.cargarComboEspecialidades();
            ID_PacienteCronico.cargarComboServicios();
        });
    ...
    GenerarReporte() {
        ...
        var url = "/Reportes/PartePacientesCronicos?area=Reportes&idTipoServicio=" + idTipoServicio
...
$(document).ready(function () {
    ID_PacienteCronico.inicializarComponentes();
    ID_PacienteCronico.listarCombos();
    ID_PacienteCronico.cargarComboServicios();
    ID_PacienteCronico.cargarComboEspecialidades();
