...
var ID_PacientexRecepcionar = {
    ...
    GenerarReporte() {
        ...
        var url = "/Reportes/PacientesxRecepcionar?area=Reportes&FechaInicio=" + FechaInicio + "&FechaFin=" + FechaFin;
...
$(document).ready(function () {
    ID_PacientexRecepcionar.inicializarComponentes();
});
