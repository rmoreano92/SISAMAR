var FechaDia;
var ID_ReporteAtencionesPFDataBruta = {
    ...
    inicializarComponentes() {
        ...
        $("#cboTipoServicio").on('change', function () {
            ID_ReporteAtencionesPFDataBruta.cargarComboServicios();
        });
    ...
    GenerarReporte() {
        ...
        var url = "/Reportes/rptProduccionEstadisticaGeneral2?area=Reportes&FechaInicio=" + FechaInicio + "&FechaFin=" + FechaFin
...
$(document).ready(function () {
    ID_ReporteAtencionesPFDataBruta.inicializarComponentes();
    ID_ReporteAtencionesPFDataBruta.cargarComboServicios();
});
