var ID_ReporteProdMedSinStock = {
    ...
    GenerarReporte() {
        ...
        Cargando(1);
        fetch('/ReportesFarmacia/ReporteProdMedSinStock?area=Farmacia', {
            method: 'POST',
            body: formData
        })
            .then(response => {
            ...
            .then(blob => {
                ...
                a.href = url;
                a.download = 'Reporte_ProdMed_SinStock.xlsx';
...
$(document).ready(function () {
    ID_ReporteProdMedSinStock.Inicializar();
});
