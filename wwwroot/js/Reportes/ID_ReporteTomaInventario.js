var ID_ReporteTomaInventario = {
    ...
    GenerarReporte() {
        ...
        Cargando(1);
        fetch('/ReportesFarmacia/ReporteTomaInventario?area=Farmacia', {
            method: 'POST',
            body: formData
        })
            .then(response => {
            ...
            .then(blob => {
                ...
                a.href = url;
                a.download = 'Reporte_TomaInventario.xlsx';
...
$(document).ready(function () {
    ID_ReporteTomaInventario.Inicializar();
});
