...
function listaMeses() {
    ...
    $.ajax({
        async: false,
        cache: false,
        url: "/DashBoardEmergencia/ListarMeses?area=Emergencia",
        datatype: "json",
        type: "get",
...
function cargarGrafico() {
    ...
    $.ajax({
        method: "POST",
        url: "/DashBoardEmergencia/ListadoPrincipal?area=Emergencia",
        data: midata,
        dataType: "json",
        processData: false,
        contentType: false,
    ...
    $.ajax({
        method: "POST",
        url: "/DashBoardEmergencia/ListadoCitasAtendidos?area=Emergencia",
        data: midata,
        dataType: "json",
        processData: false,
        contentType: false,
