var ConfigReslab = {
    ...
    async CargarFormatoResultadosLaboratorio(idProducto) {
        var resp = null;
        ...
        try {
            ...
            datos = await
                $.ajax({
                    method: "POST",
                    url: "/ConfiguracionResultadosLaboratorio/LabItemsCptSeleccionarPorProducto?area=Comun",
    ...
    ListarProcedimientoLabConfigurar: async function (IdSubGrupo, Codigo, Nombre, tabla) {
        Cargando(1)
        ...
        let response = await HttpClient.Post(`/ConfiguracionResultadosLaboratorio/ListarProcedimientoLabConfigurar`, formData)
    ...
    LabItemsGruposSeleccionarTodos: async function (Filtro) {
        Cargando(1)
        ...
        let response = await HttpClient.Post(`/ConfiguracionResultadosLaboratorio/LabItemsGruposSeleccionarTodos`, formData)
    ...
    LabItemsSeleccionarTodos: async function (Filtro) {
        ...
        let response = await HttpClient.Post(`/ConfiguracionResultadosLaboratorio/LabItemsSeleccionarTodos`, formData)
    ...
    LabItemsCptModificar: async function () {
        ...
        formData.append("opcion", ConfigReslab.opcion);


        let response = await HttpClient.Post(`/ConfiguracionResultadosLaboratorio/LabItemsCptModificar`, formData)
    ...
    Events: function () {
        ...
        $('#btnModificar').on('click', async function () {
            ...
            ConfigReslab.opcion = 'M'

            await ConfigReslab.CargarDatos(row)
        ...
        $('#btnGuardar').on('click', async function () {
            ...
            //let resultados = await ConfigReslab.CargarFormatoResultadosLaboratorio($('#hdIdServicioCpt').val())
            ...
            let labItemModificar = await ConfigReslab.LabItemsCptModificar()
        ...
        $('#btnModalGrupoItem').on('click', async function () {
            ...
            await ConfigReslab.LabItemsGruposSeleccionarTodos('')
        })
        ...
        $('#btnModalItem').on('click', async function () {
            ...
            await ConfigReslab.LabItemsSeleccionarTodos('')
        })
        ...
        $('#btnBuscarItemGrupo').on('click', async function () {
            ...
            await ConfigReslab.LabItemsGruposSeleccionarTodos(filtro)
        })
        ...
        $('#btnLimpiarBusqItem').on('click', async function () {
            ...
            await ConfigReslab.LabItemsSeleccionarTodos(filtro)
        })
        ...
        $('#btnBuscar').on('click', async function () {
            ...
            await ConfigReslab.ListarProcedimientoLabConfigurar(idGrupo, codigo, nombre, oTable_TableProcedimiento)
        })
        ...
        $('#btnBuscarProcedimiento').on('click', async function () {
            ...
            await ConfigReslab.ListarProcedimientoLabConfigurar(0, codigo, nombre, oTable_TableProcedimientoBusq)
        })
        ...
        $('#tblProcedimientoBusq').on('dblclick', 'tr', async function () {
            ...
            let resultados = await ConfigReslab.CargarFormatoResultadosLaboratorio(row.idProducto)
    ...
    CargarDatos: async function (data) {
        ...
        let resultados = await ConfigReslab.CargarFormatoResultadosLaboratorio(data.idProducto)
        ...
        if (ConfigReslab.opcion != 'A' && ConfigReslab.opcion != 'M') {
            $('#btnModalServicioCpt').prop('disabled', true)

            if (ConfigReslab.opcion != 'C' || ConfigReslab.opcion != 'E') {
