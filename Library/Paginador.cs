...
namespace WebAppMaternidad.Library
{
    public class Paginador<T>
    {
        ...
        public object[] paginador(List<T> table, int pagina, String area, String controller, String action, String host,String Search)
        {
            if (pagina == 0)
            {
            ...
            if (pagi_totalPags > 0)
            {
                if ((pagi_totalPags % pagi_cuantos) > 0 || (pagi_cuantos / pagi_totalPags) > 0)
                {
                    pagi_totalPags += 1;
                }            
            }
            ...
            if (pagi_actual != 1)
            {
                ...
                pagi_navegacion += "<li class='paginate_button page-item'><a class='page-link' id='paginas1' href='" + host + "/" + controller + "/" + action + "?id=" + pagi_url + Search + "&area=" + area + "'>" + pagi_nav_primera + "</a></li>";

                // Si no estamos en la página 1. Ponemos el enlace "anterior" 
                pagi_url = pagi_actual-1; //será el número de página al que enlazamos 
                pagi_navegacion += "<li class='paginate_button page-item previous'><a class='page-link' id='paginas1' href='" + host + "/" + controller + "/" + action + "?id=" + pagi_url+ Search + "&area=" + area + "'>" + pagi_nav_anterior + " </a></li>";
            }
            ...
            for (int pagi_i = pagi_nav_desde; pagi_i <= pagi_nav_hasta; pagi_i++)
            {
                ...
                if (pagi_i == pagi_actual)
                {
                    ...
                    pagi_navegacion += "<li class='paginate_button page-item active'><a class='page-link'  id='paginas2'>" + pagi_i + "  </a></li>";
                }
                else
                {
                    // Si es cualquier otro. Se escribe el enlace a dicho número de página. 
                    pagi_navegacion += "<li class='paginate_button page-item'><a class='page-link' id='paginas1' href='" + host + "/" + controller + "/" + action + "?id=" + pagi_i + Search + "&area=" + area + "'>" + pagi_i + " </a></li>";
                }
            }
            if (pagi_actual < pagi_totalPags)
            {
                ...
                pagi_navegacion += "<li class='paginate_button page-item next'><a class='page-link' id='paginas1' href='" + host + "/" + controller + "/" + action + "?id=" + pagi_url + Search + "&area=" + area + "'>" + pagi_nav_siguiente + "</a></li>";
                ...
                pagi_navegacion += "<li class='paginate_button page-item'><a class='page-link'  href='" + host + "/" + controller + "/" + action + "?id=" + pagi_url+ Search + "&area=" + area + "'>" + pagi_nav_ultima + "</a></li>";
            }
            /* 
