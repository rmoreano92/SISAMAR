...
namespace CapaDatos
{
    public class DalEvaluacionHospitalizacion
    {
        ...
        public Task<DataSet> SeleccionarEvaluacionDetalle(int idAtencion, int idServicio, int idUsuario)
        {
            ...
            return Task.Run(() =>
            {
                ...
                using (SqlConnection conn = cx.obtenerConexion())
                {
                    using (SqlDataAdapter da = new SqlDataAdapter())
                    {
                        string sql = "web_EvaluacionHospitalizacionDetalleSeleccionar";
                        da.SelectCommand = new SqlCommand(sql, conn);
                        da.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        public Task<DataSet> SeleccionarEvaluacionDetallePorEvaluacion(int idAtencion, int idServicio, int nroEvaluacion, int idUsuario)
        {
            ...
            return Task.Run(() =>
            {
                ...
                using (SqlConnection conn = cx.obtenerConexion())
                {
                    using (SqlDataAdapter da = new SqlDataAdapter())
                    {
                        string sql = "web_EvaluacionHospitalizacionDetalleSeleccionarPorEvaluacion";
                        da.SelectCommand = new SqlCommand(sql, conn);
                        da.SelectCommand.CommandType = CommandType.StoredProcedure;
